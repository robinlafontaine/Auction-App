 ...
 * @author robin
 */
public class enchere_fin extends javax.swing.JFrame {

    /**
     * Creates new form enchere_fin
     */
    public enchere_fin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        banner_show.setText("Dommage !");

        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Plus de chance la prochaine fois !");

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(banner_show, javax.swing.GroupLayout.DEFAULT_SIZE, 400, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(enchere_fin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
